...
<td class="org-left">Question that the challenge or change leads to<sup><a id="fnr.1" class="footref" href="#fn.1">1</a></sup></td>
</tr>


<tr>
<td class="org-left">Answer</td>
<td class="org-left">The answer to the question that is posed<sup><a id="fnr.2" class="footref" href="#fn.2">2</a></sup></td>
</tr>
</tbody>
</table>
...
1.  Given the situation, could "We don't have a plan in place to do
    this." be a possible alternative **complication**?<sup><a id="fnr.3" class="footref" href="#fn.3">3</a></sup>
2.  Which **question** would this alternative complication lead
    to?<sup><a id="fnr.4" class="footref" href="#fn.4">4</a></sup>
...
<sup><a id="fn.1" href="#fnr.1">1</a></sup> There are several different types of questions: How, Why, What,
...
<sup><a id="fn.2" href="#fnr.2">2</a></sup> The introduction only contains the hypothesis, the first or
tentative answer. The full answer is contained in the entire body of
the pyramid of arguments.

<sup><a id="fn.3" href="#fnr.3">3</a></sup> "We don't have a plan in place to do this" would be possible,
but it would be better to anchor this complication by mentioning the
need for a **plan**.

<sup><a id="fn.4" href="#fnr.4">4</a></sup> The new complication "We don't have a plan in place to do this",
