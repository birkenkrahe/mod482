...
** Agenda
  ...
  | Lecture      | Introduction to BPMN  | 30 min |

* Week 11 - October 28

  | BPMN recap    | Rules                         | 15 min |
  | BPMN practice | Diagram with errors           | 15 min |
  |               | Remodel a diagram in BPMN     | 20 min |
  |               | Build BPMN model from scratch | 30 min |
  | Homework      | Submit BPMN model             | 30 min |
