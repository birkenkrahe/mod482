...
** Convert an EPC to a BPMN diagram
   ...
   which one?[fn:7]. I've cleaned it up (also avoiding the loop but
   retaining all the important information) in the diagram
   below. Convert this diagram ([[https://academic.signavio.com/p/editor?id=6a471b2d78384fc4b278ceb678f675ee][Signavio]]) into a BPMN 2.0 diagram!
